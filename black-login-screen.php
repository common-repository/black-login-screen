<?php
/*
Plugin Name: Black Login Screen
Plugin URI:  http://wordpress.org/plugins/black-login-screen
Description: Change WordPress login screen to black color to make it more contrast.
Version:     1.0
Author:      silver530
Author URI:  http://www.pixelwars.org
License:     GPLv2 or later
Text Domain: black_login_screen
Domain Path: /langs/
*/
